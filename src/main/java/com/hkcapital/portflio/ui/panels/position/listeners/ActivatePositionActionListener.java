...
public class ActivatePositionActionListener implements ActionListener
{
    /**
    ...
    public ActivatePositionActionListener(PositionTableModel<Position> tableModel, //
