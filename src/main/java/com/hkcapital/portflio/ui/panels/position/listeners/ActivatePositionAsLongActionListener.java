...
public class ActivatePositionAsLongActionListener implements ActionListener
{
    /**
    ...
    public ActivatePositionAsLongActionListener(PositionTableModel<Position> tableModel, //
