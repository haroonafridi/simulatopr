...
@Component
public class EtoroOrdersPanelTest
{
    private final ServiceRegistery<Service> serviceRegistery;
    private final ConfigurationService configurationService;

    public EtoroOrdersPanelTest(final ServiceRegistery<Service> serviceRegistery)
    {
    ...
    public void launch()
    {
        ...
        com.hkcapital.portflio.ui.panels.configuartion.panels.ConfigurationPanel instrumentPanel = new ConfigurationPanel(serviceRegistery, null);
