...
public class DeactivatePositionActionListener implements ActionListener
{
    /**
    ...
    public DeactivatePositionActionListener(PositionTableModel<Position> tableModel, //
