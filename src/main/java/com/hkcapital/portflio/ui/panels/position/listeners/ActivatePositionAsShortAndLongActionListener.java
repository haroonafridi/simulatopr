...
public class ActivatePositionAsShortAndLongActionListener implements ActionListener
{
    /**
    ...
    public ActivatePositionAsShortAndLongActionListener(PositionTableModel<Position> tableModel, //
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        position.setIsLong(Boolean.FALSE);
        position.setIsShortLong(Boolean.TRUE);
