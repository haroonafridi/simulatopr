...
import com.hkcapital.portflio.market.structure.OrderType;
...
{
    private final Logger logger = LoggerFactory.getLogger(FifteenMinuteTimeFrameOrderProcessorImpl.class);
    ...
    private void process(LiveInstrumentRate instrumentRate,
                         Position position,
                         Instrument inst)
    {
