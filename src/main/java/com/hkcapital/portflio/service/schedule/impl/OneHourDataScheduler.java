...
@Service("OneHourDataScheduler")
public class OneHourDataScheduler implements ScheduleService
{
    ...
    public OneHourDataScheduler(EtoroCandleService candleService, InstrumentService instrumentService)
    {
    ...
    public void run()
    {
        ...
        instrumentService.findByActive(Boolean.TRUE).forEach(instrument ->
                candleService.fetchAndSaveCandleInformation(18, TimeFrame.OneHour, 1, TimeFramesUnit.MINUTE));
    }
}
